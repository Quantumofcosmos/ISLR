...
Here $\hat{y_i}$ is prediction lable for $i$th observation made using $\hat{f}$. The Test error rate associated with test observations$(x_0,y_0)$ are given by $$Ave(I(y_0\neq\hat{y_0}))$$
